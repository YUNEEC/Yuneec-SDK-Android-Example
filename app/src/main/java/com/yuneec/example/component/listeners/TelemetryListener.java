...
class TelemetryListener
{
   ...
   public static
   void registerBatteryListener ( final Context context )
   {
      ...
      if ( batteryListener == null )
      {
         ...
         batteryListener = new Telemetry.BatteryListener ( )
         {
            ...
            @Override
            public
            void onBatteryCallback ( Telemetry.Battery battery )
            {
   ...
   public static
   void registerHealthListener ( final Context context )
   {
      ...
      if ( healthListener == null )
      {
         ...
         healthListener = new Telemetry.HealthListener ( )
         {
            ...
            @Override
            public
            void onHealthCallback ( Telemetry.Health health )
            {
